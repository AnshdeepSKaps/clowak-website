    ...
    return (
        <div id="about-us" className="d-flex flex-row justify-content-center align-items-center">
            <div>
                ...
                <p id="about-us-description" className="mt-5 text-justify" style={{ fontWeight: "600", fontSize: "1.3rem" }}>We, at Clowak Innovations, strive to create ingenious products that focus on making the
