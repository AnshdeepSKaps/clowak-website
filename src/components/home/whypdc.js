...
export default function Whypdc() {
    ...
    return (
        <div id="why-pdc" className="">
            ...
            <p className="home-text text-center mt-5" style={{ margin: "auto", width: "70vw", fontWeight: "600", fontSize: "1.3rem" }}>Certain people face difficulty in getting regular dental checkups. They may be elderly, unable
